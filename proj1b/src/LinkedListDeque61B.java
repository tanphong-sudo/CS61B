...
public class LinkedListDeque61B<T> implements Deque61B<T> {
    ...
    public boolean equals(Object b) {
        if (b == null || !(b instanceof LinkedListDeque61B)) {
            return false;
        }
        LinkedListDeque61B<T> other = (LinkedListDeque61B<T>) b;
        if (this.size != other.size) {
            return false;
        }
        Node<T> p1 = this.first;
        Node<T> p2 = other.first;
        while (p1 != this.sentinal && p2 != other.sentinal) {
